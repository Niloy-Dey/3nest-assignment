                ...
                <div class="container px-5 pt-0 mt-0  mx-auto flex flex-wrap items-center">
                    ...
                    <div class="lg:w-2/6 md:w-1/2 bg-gray-100 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        <form action="" onSubmit={handleSubmit(onSubmit)} >
                            ...
                            <input class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" type="submit" value="Sign In " />
                        </form>
                        <p class="text-xs text-gray-500 mt-3">You have no Account Please <Link to="/signUp" className='text-blue-400 font-bold '>SignUp</Link></p>
                    </div>
                </div>
            </section>
